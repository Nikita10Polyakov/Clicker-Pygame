...
timer = Label(50, 80, 50, 40, back)
timer.set_text('0', 40, DARK_BLUE)
timer.draw(0, 0)

score_text = Label(290, 0, 50, 50, back)
score_text.set_text('Рахунок:', 40, DARK_BLUE)
score_text.draw(20, 20)

score = Label(380, 80, 50, 40, back)
...
while True:
    ...
    if new_time - start_time >= 11:
        ...
        win.set_text("Час вичерпано!!!", 40, DARK_BLUE)
        win.draw(110, 180)
    ...
    if points >= 5:
        ...
        win.set_text("Ты переміг!!!", 40, DARK_BLUE)
        win.draw(140, 180)
        resul_time = Label(90, 230, 250, 250, LIGHT_GREEN)
        resul_time.set_text("Час проходження: " + str(int(new_time - start_time)) + " секунд", 30, DARK_BLUE)
